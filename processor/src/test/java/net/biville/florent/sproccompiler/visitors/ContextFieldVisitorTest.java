...
public class ContextFieldVisitorTest
{
    ...
    public void rejects_final_context_fields()
    {
        ...
        assertThat( result ).extracting( CompilationMessage::getContents ).containsExactly(
                "@org.neo4j.procedure.Context usage error: field FinalContextMisuse#graphDatabaseService should be public, non-static and non-final" );
    }
    ...
    public void warns_against_unsupported_injected_types()
    {
        ...
        assertThat( result ).extracting( CompilationMessage::category, CompilationMessage::getContents )
