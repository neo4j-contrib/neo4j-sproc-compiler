...
public class DuplicatedStoredProcedureValidatorTest {
    ...
    public void detects_duplicate_procedure_with_default_names() {
        ...
        assertThat(errors).hasSize(2)
                .extracting("element", "errorMessage")
                .containsExactlyInAnyOrder(
                        tuple(procedureA, "Procedure name <" + procedureName + "> is already defined 2 times. It should be defined only once!"),
                        tuple(procedureB, "Procedure name <" + procedureName + "> is already defined 2 times. It should be defined only once!")
                );
    }
    ...
    public void detects_duplicate_procedure_with_overridden_names() {
        ...
        assertThat(errors).hasSize(2)
                .extracting("element", "errorMessage")
                .containsExactlyInAnyOrder(
                        tuple(procedureA, "Procedure name <override> is already defined 2 times. It should be defined only once!"),
                        tuple(procedureB, "Procedure name <override> is already defined 2 times. It should be defined only once!")
                );
    }
